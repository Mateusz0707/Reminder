...
<body class="flex flex-col h-screen">
    ...
    <div style="border-bottom:1px solid lightgray;" class="w-full h-13 bg-gray-100">
        ...
        <div class="fixed top-0 right-0 p-1 flex space-x-2">
            <button
                class="bg-transparent text-right   py-2 px-1 rounded focus:outline-none focus:ring-2 focus:ring-green-600"
                id="openButton" onclick="openPopup()">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                </svg>
            </button>
            <button class="bg-transparent text-right rounded focus:outline-none ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
